...
const ImportItemOpening = () => {
  return (
    <div className='container-fluid'>
    <div className='row'>
      <div className='col-md-12 px-3'>
          <div className=' mt-3 d-flex justify-content-between'>
          <h4>Import Opening Balance</h4>
                  ...
                  <form action="">
                      <div className='row '>
                          <div className='col-md-3 d-flex justify-content-center align-items-center '>
                              <label htmlFor="BrowseFile" className='border rounded-3 border-primary px-2 py-1 fs-6 cursor'>BrowseFile</label>
...
export default ImportItemOpening