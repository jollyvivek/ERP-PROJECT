  ...
  return (
    <div className='container-fluid'>
		...
		<div className='col-md-12 px-3'>
			...
			<h5>Internal Test Certificate Details</h5>
			<div><input type="text" className='form-control' /></div>
			</div>
			<div className='row mt-3'>
				<div className='col-md-10 offset-1 border rounded-3 py-3 mt-1'>
					<form action="">
						<div className='row '>
...
export default InternalTestCertificate